...
class Int16Handler(BIOSHandler):
    ...
    def handle(self, uc: Uc) -> None:
        ...
        if ah == 0x00:
            ...
            self.log(f"[INT 0x16] Unhandled function AH=0x{ah:02X}")
            uc.emu_stop()

    def _read_keystroke(self, uc: Uc) -> None:
        """AH=0x00: Read keystroke."""
        self.log("[INT 0x16] Read keystroke")
